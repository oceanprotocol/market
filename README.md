...
<h1 align="center">Cannabis Data Marketplace</h1>
...
- The name "Cannabis Data Market" is also copyright protected and should be changed to the name of your market.
...
Cannabis Data Market also includes a number of advanced features that are suitable for an enterprise data market, such as:
...
Cannabis Data Market comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
