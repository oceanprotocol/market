...
- The name "Datanome" is also copyright protected and should be changed to the name of your market.
...
If you are looking to fork Datanome and create your own marketplace, you will find the following guides useful in our docs:

- [Forking Datanome](https://docs.oceanprotocol.com/building-with-ocean/build-a-marketplace/forking-ocean-market)
...
Datanome comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
